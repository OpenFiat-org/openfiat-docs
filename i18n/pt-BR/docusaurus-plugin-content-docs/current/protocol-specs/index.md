---
title: Especificações do protocolo
---

# Especificações do protocolo

Cada documento do OpenFiat Protocol Suite (OFS) define um componente do protocolo
em detalhe pronto para implementação. Todas as specs vivem em
