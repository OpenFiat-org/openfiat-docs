---
title: Registre um provedor de oráculo
---

# Registre um provedor de oráculo

Registre-se no Registro de Serviços (OFS-1500) de um nó como Provedor de Oráculo,
depois publique um registro de taxa de câmbio assinado (OFS-7000). A taxa mediana
entre todos os provedores de um par é o que os anúncios de preço flutuante
referenciam.
...
Fonte completa: [`examples/oracle_provider.rs`](https://github.com/OpenFiat-org/openfiat-sdks/blob/main/rust/examples/oracle_provider.rs)
(`cargo run --example oracle_provider` a partir de `openfiat-sdks/rust`).
...
Fonte completa: [`examples/oracle_provider.ts`](https://github.com/OpenFiat-org/openfiat-sdks/blob/main/typescript/examples/oracle_provider.ts)
(`pnpm tsx examples/oracle_provider.ts` a partir de `openfiat-sdks/typescript`).
