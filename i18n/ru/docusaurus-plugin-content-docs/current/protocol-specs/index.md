---
title: Спецификации протокола
---

# Спецификации протокола

Каждый документ OpenFiat Protocol Suite (OFS) определяет один компонент протокола
с детализацией, готовой к реализации. Все спецификации живут в
